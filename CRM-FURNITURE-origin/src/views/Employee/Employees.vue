...
const pageUpdate = () => {
  let page = ref(localStorage.getItem('employee_page_number'))
  useEmployee.getByPage(page.value).then((res) => {
    console.log(page.value);
    pagination.totalPage= res.data.pages;
    pagination.currentPage = page;
    pagination.totalCount = res.data.allItems;
    pagination.start = res.data.start;
    pagination.end = res.data.finish;
    store.SET_LIST(res.data.paginated)
  })
}
...
const addEmployee = () => {
  ...
  const employee = {
    ...
    role_id: Number(employeeInfo.role_id),
    card: Number(employeeInfo.card),
...
const next = () => {
  ...
  if(page.value<pagination.totalPage){
    localStorage.setItem('employee_page_number', +page.value+1)
  }
  pageUpdate()
}
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
              ...
              <div>
                ...
                >
                  ...
                  <option value="5">Eltuvchi</option>
                </select>
              </div>
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                <tr v-for="(el, i) in store.LIST" :key="i" class="border-b dark:border-gray-700">
                  ...
                  <td class="px-4 py-3">{{ el.phone_number
                  }}</td>
                  <td class="px-4 py-3">{{ el.role.role }}</td>
          ...
          >
            <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
              Yozuvlar:
              <span class="font-semibold text-gray-900 dark:text-white">{{pagination.start}} dan{{pagination.end}} gacha  </span>
              Xamma yozuvlar: 
              <span class="font-semibold text-gray-900 dark:text-white">{{pagination.totalCount}} ta  </span>
              Xamma saxifalar: 
              <span class="font-semibold text-gray-900 dark:text-white">{{pagination.totalPage}}ta  </span>
            </span>
