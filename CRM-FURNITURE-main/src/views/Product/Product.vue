...
import { ProductStore } from '../../stores/products/product';
import {useProduct} from '../../service/product/index'
import { toast } from 'vue3-toastify'
import {useProductType} from '../../service/productType/index'

const productTypeStore = ProductTypeStore()
...
const listUpdate = () => {
    useProductType.getAll().then((res) => {
      productTypeStore.SET_LIST(res.data)
    })
    useProduct.getAll().then((res) => {
      console.log("GET ALLL",res.data);
      productStore.SET_LIST(res.data)
    })
}
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
          ...
          <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                <tr v-for="el in productStore.LIST" :key="el.id" class="border-b dark:border-gray-700">
                  <th
                    scope="row"
                  ...
                  <td class="px-4 py-3">{{el.productType.type}}</td>
